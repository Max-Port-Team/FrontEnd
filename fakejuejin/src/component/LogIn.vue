    ...
    <form class="auth-form">
      ...
      <div class="panel">
        ...
        <div class="input-group">
          <div class="input-box">
            <input name="loginPhoneOrEmail" autocomplete="off" placeholder="邮箱/手机号（国际号码加区号）" class="input"
              maxlength="64">
          </div>
          <div class="input-box">
            <input name="loginPassWord" autocomplete="off" placeholder="请输入密码" type="password" class="input"
              maxlength="64">
          </div>
        </div>
      ...
      <div class="agreement-box">
        注册登录即表示同意<a href="#" target="_blank">用户协议</a>、<a href="#" target="_blank">隐私政策</a>
      </div>
    </form>
  </div>
</template>
